      ...
      <main>
        <div className={`container ${styles.mentions}`}>
          ...
          <p>
            ...
            Google Analytics, et nous permettent de mesurer l'audience de notre
            site web, les consultations et les éventuelles erreurs afin
            d’améliorer constamment l’expérience des utilisateurs. Ces données
            sont utilisées par RAMBEAU MULTISERVICES, responsable du traitement
            des données, et ne seront jamais cédées à un tiers ni utilisées à
            d’autres fins que celles détaillées ci-dessus.
          </p>
          <p>
          ...
          <p>
            ...
            notamment par les articles L.335-2 et suivants et L.716-1 et
          ...
          <p>
            ...
            régies par la loi française. En cas de litige relatif à leur
            validité, leur interprétation et/ou leur application, attribution
            expresse de juridiction est donnée aux tribunaux compétents.
          </p>
          <p>
          ...
          <p>
            Pour toute remarque sur le fonctionnement du Site, écrivez ou
            adressez un message au webmaster :
          </p>
